...
let student1: Student = { id: 1, name: "George", surname: "Strait", age: 66, email: "info@georgestrait.com", Grades: Cons({ courseId: "SWE01", studentId: 1, grade: 7.4 }, Empty()) }
...
let student3: Student = { id: 3, name: "Kane", surname: "Brown", age: 25, email: "info@kanbrown.com", Grades: Cons({ courseId: "SWE01", studentId: 3, grade: 8.7 }, Empty()) }
...
let student5: Student = { id: 5, name: "Keith", surname: "Urban", age: 66, email: "info@keithurban.com", Grades: Cons({ courseId: "SWE01", studentId: 5, grade: 5.5 }, Empty()) }
let student6: Student = { id: 6, name: "Blake", surname: "Shelton", age: 46, email: "info@blakeshelton.com", Grades: Cons({ courseId: "SWE01", studentId: 6, grade: 4 }, Empty()) }
let student7: Student = { id: 7, name: "Carie", surname: "Underwood", age: 25, email: "info@carie.com", Grades: Empty() }
let student8: Student = { id: 8, name: "Miranda", surname: "Lambert", age: 42, email: "info@lambert.com", Grades: Cons({ courseId: "SWE01", studentId: 8, grade: 10 }, Empty()) }
